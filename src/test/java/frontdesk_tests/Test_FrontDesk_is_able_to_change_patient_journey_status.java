...
public class Test_FrontDesk_is_able_to_change_patient_journey_status extends FrontDeskLoginBaseClass{
		
	@Test
	public void Test_FrontDesk_is_able_to_change_patient_journey_status_to_Checkin() throws InterruptedException {
	...
	@Test
	public void Test_FrontDesk_is_able_to_change_patient_journey_status_to_Engaged() throws InterruptedException {
		DashBoard_Modules Patients=PageFactory.initElements(driver, DashBoard_Modules.class);
		Patients.getPatients().click();
		Thread.sleep(2000);
		Appointments_Page Appointment=PageFactory.initElements(driver, Appointments_Page.class);
	...
	@Test
	public void Test_FrontDesk_is_able_to_change_patient_journey_status_to_Checkout() throws InterruptedException {
		DashBoard_Modules Patients=PageFactory.initElements(driver, DashBoard_Modules.class);
		Patients.getPatients().click();
		Thread.sleep(2000);
		Appointments_Page Appointment=PageFactory.initElements(driver, Appointments_Page.class);
	...
	@Test
	public void Test_FrontDesk_is_able_to_change_patient_journey_status_to_Confirmed() throws InterruptedException {
		DashBoard_Modules Patients=PageFactory.initElements(driver, DashBoard_Modules.class);
		Patients.getPatients().click();
		Thread.sleep(2000);
		Appointments_Page Appointment=PageFactory.initElements(driver, Appointments_Page.class);
