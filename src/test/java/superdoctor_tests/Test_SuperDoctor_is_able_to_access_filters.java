...
public class Test_SuperDoctor_is_able_to_access_filters extends BaseClass {


	@Test
	public void Test_SuperDoctor_is_able_to_apply_Consultationfilter_in_appointmentsScreen() throws InterruptedException {
	...
	@Test
	public void Test_SuperDoctor_is_able_to_apply_Counsellingfilter_in_appointmentsScreen() throws InterruptedException {
		DashBoard_Modules Patients=PageFactory.initElements(driver, DashBoard_Modules.class);
		Patients.getPatients().click();
		Thread.sleep(2000);
		Appointments_Page Appointment=PageFactory.initElements(driver, Appointments_Page.class);
	...
	@Test
	public void Test_SuperDoctor_is_able_to_apply_Sessionfilter_in_appointmentsScreen() throws InterruptedException {
		DashBoard_Modules Patients=PageFactory.initElements(driver, DashBoard_Modules.class);
		Patients.getPatients().click();
		Thread.sleep(2000);
		Appointments_Page Appointment=PageFactory.initElements(driver, Appointments_Page.class);
