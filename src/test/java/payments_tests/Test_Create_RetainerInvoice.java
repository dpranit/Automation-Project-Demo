...
public class Test_Create_RetainerInvoice extends BaseClass{

	@Test(groups= {"SuperDoctor"},dataProvider="TestData")
	public void Create_New_RetainerInvoice(String Patient,String amount, String mode) throws InterruptedException {
		...
		RetainerInv.click();
		WebElement NewRetainer= driver.findElement(By.xpath("//button[text()=' + Retainer Invoice ']"));
		NewRetainer.click();
		Thread.sleep(3000);
